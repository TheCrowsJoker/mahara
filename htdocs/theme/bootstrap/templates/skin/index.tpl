...
{if $skins}
<div class="mtl panel-items js-masonry" data-masonry-options='{ "itemSelector": ".panel" }'>
...
<div class="panel panel-default">
    ...
    <div class="skin-controls panel-footer">
        ...
        {else}
        <div class="skinactions pull-right">
            {if $skin.type == 'public' && $skin.owner != $user}
                {if !$skin.favorite}
                <a href="{$WWWROOT}skin/favorite.php?add={$skin.id}" title="{str tag='addtofavorites' section='skin'}" class="btn btn-xs">
                ...
                {else}
                <a href="{$WWWROOT}skin/favorite.php?del={$skin.id}" title="{str tag='removefromfavorites' section='skin'}" class="btn btn-xs">
